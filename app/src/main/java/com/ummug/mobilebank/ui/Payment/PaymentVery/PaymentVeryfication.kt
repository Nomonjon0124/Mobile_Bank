...
@AndroidEntryPoint
class PaymentVeryfication :Fragment(R.layout.fragment_verification) {

    private val viewModel:PaymentVeryViewModel by viewModels ()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.RESUMED) {
                viewModel.openPaymentVeryFlow.collect {
